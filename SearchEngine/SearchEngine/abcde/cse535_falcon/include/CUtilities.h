...
public:
	...
	static std::string stop_word_str;
	static std::string dir_path;
	static std::string semwiki_dir_path;
	static std::string term_indx_dirx_path;
	static int online_mode_enabled;
	static int num_for_onlie_mode;
...
public:
	...
	static void remove_duplicates(std::vector<std::string>& token_vec);
	...
	int static toInt(std::string str);
